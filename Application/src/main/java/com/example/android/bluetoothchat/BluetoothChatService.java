...
public class BluetoothChatService {
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            byte[] buffer = new byte[990];//Khởi tạo mảng byte để đọc
            byte[] imgBuffer = new byte[1024 * 1024];//Dung lượng của bức ảnh
            int bytes;
            int pos = 0;
            ...
            while (mState == STATE_CONNECTED) {
                ...
                try {
                    ...
                    //đọc thành công thì gửi bytes về UI để hiển thị ảnh
        ...
        public void write(byte[] buffer) {
            android.util.Log.i("TAG11", buffer.toString());
            try {
